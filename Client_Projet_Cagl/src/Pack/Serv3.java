...
public class Serv3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                System.out.println("Serveur Serv3 en attente...");
                ...
                try {
                    ...
                    if(SD == null) {
                    	in.ajouterServerDetails(new ServerDetails(1,"Serv3",ipAddress,port));
                    }
