...
public class Serv2 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                System.out.println("Serveur Serv2 en attente...");
                ...
                try {
                    ...
                    if(SD == null) {
                    	in.ajouterServerDetails(new ServerDetails(1,"Serv2",ipAddress,port));
                    }
