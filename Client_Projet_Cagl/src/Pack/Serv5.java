...
public class Serv5 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                System.out.println("Serveur Serv5 en attente...");
                ...
                try {
                    ...
                    if(SD == null) {
                    	in.ajouterServerDetails(new ServerDetails(1,"Serv5",ipAddress,port));
                    }
