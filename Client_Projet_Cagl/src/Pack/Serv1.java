...
public class Serv1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                System.out.println("Serveur Serv1 en attente...");
                ...
                try {
                    ...
                    if(SD == null) {
                    	in.ajouterServerDetails(new ServerDetails(1,"Serv1",ipAddress,port));
                    }
